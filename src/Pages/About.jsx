    ...
    <div className="min-h-screen bg-white">
      <Navbar />
        ...
        <div className='flex flex-col gap-6 w-full md:w-1/2 max-w-xl'>
          ...
          <button onClick={handleOnClick} className='w-fit px-10 py-3 border border-black rounded-full text-lg font-medium hover:bg-black hover:text-white transition-all duration-300'>
            Say hey!
          </button>
        </div>
      </div>
      ...
      <div className="w-full pb-20">
        ...
        <div className="flex overflow-x-auto gap-6 px-10 md:px-20 scrollbar-hide py-4">
          ...
          <div className="group cursor-pointer flex-shrink-0 w-64 md:w-80">
            <div className="relative bg-gray-100 aspect-[3/4] overflow-hidden rounded-lg">
              <img src="cat.jpg" alt="Image 1" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
            </div>
            <div className="mt-4">
              <h3 className="text-xs uppercase tracking-widest font-medium">Test 1</h3>
            </div>
          </div>
          ...
          <div className="group cursor-pointer flex-shrink-0 w-64 md:w-80">
            ...
            <div className="mt-4">
              <h3 className="text-xs uppercase tracking-widest font-medium">Test 7</h3>
            </div>
          </div>
            ...
            <div className="mt-4">
              <h3 className="text-xs uppercase tracking-widest font-medium">Test 8</h3>
            </div>
          </div>
